...
export default function reducer(state = admin, action = {}) {
  switch (action.type) {
    ...
    case LOAD_SERVICE_GROUPS_FOR_SERVICE:
      return {
        ...state,
        loading: false,
        adminLoading: null,
        serviceGroupsForServiceComponent: action.payload,
        message: null,
      };
    case LOAD_SERVICES:
      return {
    ...
    case UPDATE_SERVICE_GROUP:
      ...
      const newServiceGroupArray = state.serviceGroups.data.filter(
        (serviceGroup) => serviceGroup.id !== action.payload.id
      );
      ...
      return {
        ...
        serviceGroupsForServiceComponent: {
          ...state.serviceGroupsForServiceComponent,
          data: newServiceGroupArray,
        },
      };
    case UPDATE_SERVICE:
      const newServiceArray = state.services.data.filter(
...
export const updateContractType = (data, id) => (dispatch) => {
  dispatch(loading());
  return agent.ContractType.edit(id, data).then(
    (c) => (response) => {
...
export const deleteContractType = (id) => (dispatch) => {
  return agent.ContractType.delete(id).then(
    (c) => (response) => {
...
export const updateSkills = (data, id) => (dispatch) => {
  dispatch(loading());
  return agent.Skill.edit(id, data).then(
    (c) => (response) => {
...
export const deleteSkills = (id) => (dispatch) => {
  return agent.Skill.delete(id).then(
    (c) => (response) => {
...
export const updateQualification = (data, id) => (dispatch) => {
  dispatch(loading());
  return agent.Qualification.edit(id, data).then(
    (c) => (response) => {
...
export const deleteQualification = (id) => (dispatch) => {
  return agent.Qualification.delete(id).then(
    (c) => (response) => {
...
export const loadServiceGroups =
  (page, limit, loadingType, search) => (dispatch) => {
    dispatch(adminLoading(loadingType));
    return agent.ServiceGroup.load(page, limit, search).then(
      (response) => {
...
export const loadServiceGroupsForServiceComponent =
  (page, limit, loadingType, search) => (dispatch) => {
    dispatch(adminLoading(loadingType));
    return agent.ServiceGroup.loadForService(page, limit, search).then(
      (response) => {
...
export const createServiceGroup = (data, loadingType, search) => (dispatch) => {
  ...
  return agent.ServiceGroup.save(data).then(
    (response) => {
      ...
      dispatch(
        loadServiceGroupsForServiceComponent(
          1,
          10,
          "loadServiceGroupsForService",
          ""
        )
      );
      dispatch(
...
export const updateServiceGroup =
  (data, id, loadingType, globalFilter) => (dispatch) => {
    dispatch(adminLoading(loadingType));
    return agent.ServiceGroup.edit(id, data).then(
      (response) => {
        //handle success
        if (
          data.description.includes(globalFilter) ||
          data.name.includes(globalFilter)
        ) {
...
export const deleteServiceGroup =
  (id, loadingType, globalFilter) => (dispatch) => {
    dispatch(adminLoading(loadingType));
...
export const loadServices =
  (page, limit, loadingType, search) => (dispatch) => {
    dispatch(adminLoading(loadingType));
    return agent.Service.load(page, limit, search).then(
      (response) => {
...
export const updateService =
  (data, id, loadingType, globalFilter) => (dispatch) => {
    dispatch(adminLoading(loadingType));
    return agent.Service.edit(id, data).then(
      (response) => {
