...
// Action types
const LOAD_SEEN_AND_UNSEEN_NOTI =
  "app/appNotification/LOAD_SEEN_AND_UNSEEN_NOTI";
...
const LOAD_USER_NAVBAR_NOTIFICATIONS =
  "app/appNotification/LOAD_USER_NAVBAR_NOTIFICATIONS";
...
export function allNotiByAccount(id, search, page, limit) {
  return (dispatch) => {
    ...
    return agent.Notification.loadAllSeenAndUnseenByAccount(
      id,
      search,
      page,
      limit
