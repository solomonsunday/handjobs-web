    ...
    <>
      <div className="p-fluid">
        <div className="p-grid p-m-6">
          <Toast ref={toast} />
          <div
            className="login-pane-right p-md-4 mx-auto"
              ...
              <div className="">
                <div className="">
                  <div className="p-mt-0 p-mb-0">
                    <h4 className="sm-page-title text-center">
                      Login to your account
                    </h4>
                    <p className="p-m-4 text-center ">
                      Don’t have an account?{" "}
                      <Link
                        className="lnk-toggler font-weight-bold sign-up"
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="p-fluid">
                      <label htmlFor="email" className="">
                        <span className="text-default font-weight-bold default-color p-my-1">
                          Email
                        </span>
                      </label>
                      ...
                      <div className="p-d-flex p-jc-between">
                        <div className="p-field-checkbox"></div>
                        <div>
                          <Link
                            className="font-weight-bold forgot-pwd"
                            to="/forgotpassword"
                          >
                            Forgot password?
                          </Link>
