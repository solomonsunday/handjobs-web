...
const Video = () => {
    ...
    // const [myVideoStatus, setMyVdoStatus] = useState(true);
    ...
    useEffect(() => {
        if (userVideo && userVideoRef.current !== null) {
    ...
    useEffect(() => {
        ...
        if (myVideo && myVideoRef.current !== null) {
        ...
        <>
            <div className="App" style={{ height: "100%", width: "100%" }}>
                {/* <div style={{ border: '1px solid red', padding: '10px' }}>
                    <audio src={Teams} autoPlay loop muted="muted" />
                </div> */}
                <div className="">
                    {stream ? (
                        <div
                ...
                <div>
                    ...
                    {call.isReceivingCall && !callAccepted && (
                        <>
                            <audio autoPlay src={Teams} loop ref={audioRef} />
                            <div
                                title="Incoming Call"
