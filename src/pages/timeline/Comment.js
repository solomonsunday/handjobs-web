...
import { deleteComment, likeComment } from "../../store/modules/comment";
    ...
    <div className="timeline-commentContainer" id={key}>
      <div className="d-flex p-pl-2 p-pt-2 w-100">
        ...
        <div className="w-100">
            ...
            <div>
              {comment?.author && (
                <h6>
                  ...
                  {isMe && (
                    <small
                      className="p-mx-2 p-px-1 text-light rounded"
                      style={{ background: "green", fontSize: "0.7rem" }}
                    >
                      me
                    </small>
                  )}
              ...
              <div className="dropdown font-weight-bold mr-4 d-flex justify-content-between">
                ...
                >
                  <li
                    ...
                    onClick={(e) =>
                      dispatch(
                        deleteComment(e.currentTarget.dataset.id, postId)
                      )
                    }
                  >
                    Delete
          ...
          {!displayCommentForm && (
            <div className="p-pt-2">{comment.message}</div>
          )}
        </div>
      </div>
      {displayCommentForm && (
          ...
          <small className="d-flex align-center justify-content-start p-mt-1 p-pl-3">
            {isAuthenticated ? (
              ...
              >
                ...
                />
                {comment.likes > 0 && (
                  <span className="text-success p-px-2">{comment.likes}</span>
                )}
              </span>
            ) : (
              <p className="p-pr-2">
