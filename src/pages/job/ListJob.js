...
const CardItem = ({ job }) => (
  <div
    className="card mb-2 custom-skeleton p-p-4"
  ...
  >
    <div className="p-d-flex p-mb-3">
      ...
      />
      <div>
        <p width="10rem" className="p-mb-2">
          {job.companyName}
        </p>
        <p width="5rem" className="p-mb-2">
          Salary <strong>&#x20A6;{formatValue(job.minSalary)}</strong> -{" "}
...
const ListJob = () => {
  ...
  return (
    <div className="list-job-wrapper">
      <div className="list-job-container" style={styles.container}>
        ...
        {userAccountType === ACCOUNT_TYPE.CORPORATE && (
        ...
        <div className="p-grid rounded-3 ">
          ...
          <div className="p-col-12 p-md-6">
            {loading ? (
              ...
              <>
                <div
                  className="header-count-section"
                  style={styles.jobListingHeader}
                >
