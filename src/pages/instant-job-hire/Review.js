...
const Review = (props) => {
  ...
  useEffect(() => {
    if (appliedApplciants.length > 0) {
      const result = appliedApplciants.filter(
    ...
    <>
      <div className="content-container">
        <div className="p-grid">
          <div
            className="card review-card-size mt-2 p-col-sm-12"
            ...
            <div className="card-body p-pt-0">
              <div className="applicants-display">
                <div className="d-flex justify-content-between p-mb-1">
                  <div>
                    <h5>
                      ...
                      <span className="app-color">Rate & Review </span>
                    </h5>
                  </div>
                  <div
                ...
                <div className="d-flex d-row p-mt-3">
                  <p className="p-mr-5">
                    {" "}
                    <span className="font-weight-bold">Job Id : </span>{" "}
                    {applicant.jobId}
                  </p>
                  <p className="p-mr-5">
                    {" "}
                    <span className="font-weight-bold">Job Closed : </span>
                    <span>
                      {moment(instantJob.endDate).format("MMMM DD, YYYY")}
                    </span>
                  </p>
                  <p className="p-mr-5">
                    {" "}
                    <span className="font-weight-bold">Applicant :</span>{" "}
                    <span>{currentApplicant[0]?.name}</span>
                  </p>
                </div>
          ...
          <div
            className="card review-card-size mt-2 mb-2 p-col-sm-12"
            style={{ borderRadius: "1rem" }}
          >
            <div className="card-body p-pt-0">
              <form
                onSubmit={handleSubmit(onSubmit)}
                className="applicants-display"
              >
                <div>
                  <h5>
                    {" "}
                ...
                <div className="row p-mt-4">
                  <div className="col-2 rounded-circle">
                    {currentApplicant[0]?.imageUrl ? (
                      <img
                        src={currentApplicant[0]?.imageUrl}
                  ...
                  <div className="col-10">
                    <div>
                      ...
                      <p>
                        <span style={{ fontSize: 15 }}> Drycleaner </span>
                      </p>
                      <div>
                  ...
                  <div className="p-fluid p-formgrid p-grid">
                    ...
                    <div className="p-field p-col">
                      ...
                      {errors.reviewerDisplayName && (
                        <span className="text-danger font-weight-bold ">
                          {" "}
                          <p>{errors.reviewerDisplayName.message}</p>
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="p-fluid p-md-12 p-pl-0 p-sm-12">
                    <div className="p-field">
                      ...
                      <InputTextarea
                        ...
                        {...register("detail", {
                          required:
                            "Details about this person service is required",
                        })}
                      />
                      {errors.detail && (
                        <span className="text-danger font-weight-bold ">
