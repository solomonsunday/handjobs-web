...
import { editInstantJob, loadInstantJob } from "store/modules/instantJob";
import Job from "./Job";
  ...
  useEffect(() => {
    ...
    if (itemToEdit) {
      ...
      let category = Categories.find(
        (category) => category.name === itemToEdit.service
      );
            ...
            <div className="p-col-12 p-md-9">
              ...
              >
                <div className="card-body">
                  <InstantHeader title="Edit instant hire" showBack={true} />
                      ...
                      <div className="p-fluid p-md-6 p-sm-12">
                        <div className="p-field">
                          <label htmlFor="address">
                            Meet-up Location (if different from service
                            location){" "}
                          </label>
                          <PlacesAutocomplete
                            value={address}
                      ...
                      <div className="p-fluid p-md-6 p-sm-12">
                        <div className="p-field">
                          <label htmlFor="startDate">
                            {" "}
                            Start Date <span className="text-danger">
                              *
                            </span>{" "}
                            &nbsp; ({" "}
                            <input
