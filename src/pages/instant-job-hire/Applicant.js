    ...
    <>
      <div className="content-container">
        <div className="p-grid">
          ...
          <div
            className="card card-size mt-2 p-col-sm-12"
              ...
              <div className="applicants-display">
                <div className="d-flex justify-content-between p-mb-1">
                  <div>
                    <h5>
                      {" "}
                      <span className="font-weight-bold text-secondary text-capitalize">
                        {instantJob?.service}
                      </span>{" "}
                      <span className="app-color">
                        {applicantList?.length ? applicantList?.length : 0}{" "}
                        Applicant (
                        {applicantList?.length ? applicantList?.length : 0}{" "}
                        Result)
                      </span>
                    ...
                    <p className="font-weight-bold text-capitalize">
                      Location : <span>{instantJob?.location}</span>
                    </p>
                    <p className="font-weight-bold text-capitalize">
                      Address : <span>{instantJob?.address}</span>
                    </p>
                  </div>
                  <div>
                    <Link
                ...
                <div className="row">
                        ...
                        >
                          ...
                          <div className="card-body">
                            <div className="d-flex justify-content-between">
                              ...
                              <hr />
                              {/* </div> */}
                              <div className="applicant-actionIcons">
                                <i
                                  className="pi pi-video p-pr-2"
                                  data-toggle="tooltip"
                                  data-placement="top"
                                  title="Video Call"
                                />
                            ...
                            <p className="card-title">
                              ...
                              <span className="font-weight-bold text-capitalize">
                                <i className="align-text-button pi pi-briefcase p-mr-1"></i>
                                Occupation:
                              </span>{" "}
                              {/* <span className="app-color p-0"> */}
                              {applicant.occupation}
                              {/* </span> */}
                            </p>
                            <p className="card-title">
                              <span className="font-weight-bold text-capitalize">
                                <i className="align-text-button pi pi-user p-mr-1"></i>
                                Name :{" "}
                              </span>
                              {applicant.name}{" "}
                            </p>
                            <p className="card-text">
                              ...
                              <span className="font-weight-bold text-capitalize">
                                {" "}
                                <i class="align-text-bottom pi pi-map-marker p-mr-1"></i>
                                Location :
                              </span>
                              {applicant.address}
                            </p>
                            <p className="card-text">
                              <span className="font-weight-bold text-capitalize">
                                {" "}
                                <i className="align-text-button pi pi-phone p-mr-1"></i>
                                Phone :
                              </span>{" "}
                            ...
                            <p className="card-text">
                              <span className="font-weight-bold text-capitalize">
                                <i className="align-text-button pi pi-star p-mr-1"></i>
                                Rating :
                              </span>{" "}
                              <span className="p-p-0">
                                ...
                                <Rating
                                  ...
                                  disabled={true}
                                  cancel={false}
                                  onChange={(e) => setRating(applicant.rating)}
                                  stars={5}
                                />
                              </span>
                            </p>
                  ...
                  {applicants?.length === 0 && (
                    <strong className="mx-auto text-secondary">
                      <i>There are no applicants for this job </i>{" "}
                    </strong>
                  )}
                </div>
              </div>
        ...
        {!applicantList?.length === metaData?.itemCount && (
          <div className="p-grid">
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <p>
                    ...
                    <span className="p-p-0">{applicant.bio}</span>
                  </p>
                  <p className="card-text">
