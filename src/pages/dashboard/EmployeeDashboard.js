...
const EmployeeDashboard = () => {
  ...
  const accountStatus = useSelector(
    (state) => state.dashboard.userAccountStatus
  );
  ...
  return (
    <div className="dashboard-container">
      <h3 className="p-pb-2">
        <i className="pi pi-chart-line p-pr-2"></i>Dashboard
      </h3>
      <h6 className="p-mb-4">
        Welcome <strong className="text-green">{name}</strong>
      </h6>
      <div className="row">
        <div className="col-xl-4 col-md-6 p-mb-2 ">
          <div className="card mini-stat " style={{ borderRadius: "10px" }}>
            <div className="card-body dashboard-item">
              <div className="mb-4 text-green">
                ...
                <div className="text-green">
                  <Link to="/posts">
                    <h5 className="font-size-16 text-uppercase mt-0 dashboard-item mb-2 text-green">
                      Posts
                    </h5>
                  </Link>
                  <h4 className="font-weight-medium font-size-24 dashboard-item text-green">
                    {userPost?.data}
                  </h4>
                </div>
              </div>
            ...
            <div className="card-body dashboard-item">
              <div className="mb-4">
                ...
                <div className="text-green">
                  ...
                  <h4 className="font-weight-medium dashboard-item font-size-24 text-green">
                    {userContact?.data}
                  </h4>
                </div>
              </div>
      ...
      <div className="p-grid p-mx-lg-0 grid-margin p-py-1">
        <div className="p-col-12 p-lg-6 p-p-lg-1 p-py-0">
          <div
            className="p-card p-mt-2 p-rounded-lg activity-card p-mb-2"
            style={{ borderRadius: "10px" }}
          >
            <div className="p-card-title cardtitle h6 p-pb-2">
              Recent Activities
            </div>
            ...
            {userActivities &&
              ...
              userActivities.map((activity, idx) => (
                <div
                  key={idx}
                  className="p-card-body p-card-body-Activity p-px-3 "
                >
                  <i className="pi pi-paperclip pr-3  text-warning"></i>
                  <span className=" text-green">{activity.message}</span>
        ...
        <div className="p-col-12 p-lg-6 p-p-lg-1">
          <div
            className="p-card p-mt-2 p-rounded-lg activity-card"
            style={{ borderRadius: "10px" }}
          >
            ...
            {userAccountStatus && (
              <div className="p-card-body p-pt-0">
                {authUser?.accountType === "Artisan" && (
                  <>
                    <div className="progressBar-title">
                      ...
                      {getCompletionStatusPercent(
                        userAccountStatus?.experienceCompleted
                      ) < 100 && (
                    ...
                    <ProgressTrackerBar
                      value={getCompletionStatusPercent(
                        userAccountStatus?.experienceCompleted
                      )}
                      className="progressBar progressBar1"
                    />
                    <div className="progressBar-title">
                      <span>Portfolios Uploaded</span>
                      {getCompletionStatusPercent(
                        userAccountStatus?.portfolioUploadCompleted
                      ) < 100 && (
                        <Link to="/profile">Click here to update</Link>
                      )}
                      <span>
                    ...
                    <ProgressTrackerBar
                      ...
                      className="progressBar progressBar3"
                    />
                    <div className="progressBar-title">
                      <span>Services Updated</span>
                      {getCompletionStatusPercent(
                        userAccountStatus?.servicesCompleted
                      ) < 100 && (
                        <Link to="/profile">Click here to update</Link>
                      )}
                      <span>
                ...
                <div className="progressBar-title">
                  ...
                  {getCompletionStatusPercent(
                    userAccountStatus?.locationCompleted
                  ) < 100 && <Link to="/profile">Click here to update</Link>}
                  <span>
                    {getCompletionStatusPercent(
                      userAccountStatus?.locationCompleted
                    )}{" "}
                ...
                <ProgressTrackerBar
                  ...
                  className="progressBar progressBar2"
                />
                ...
                <ProgressTrackerBar
                  value={getCompletionStatusPercent(
                    userAccountStatus?.profileInfo
                  )}
                  className="progressBar progressBar6"
                />
